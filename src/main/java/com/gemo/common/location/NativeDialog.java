...
public class NativeDialog extends Dialog {
    ...
    public NativeDialog(Context context,Location loc_now,Location loc_end, Location gaodeEndLocation) {
    	super(context, R.style.NativeDialog);
        this.context = context;
        this.loc_now = loc_now;
        this.loc_end = loc_end;
        this.gaode_loc_end = gaodeEndLocation;
        initApps();
        setMsgDialog();
    }
    ...
    private View.OnClickListener applistener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
			...
			case "com.autonavi.minimap":
                APPUtil.startNative_Gaode(context,gaode_loc_end);
				break;
            case "com.gemo.bookstadium":
